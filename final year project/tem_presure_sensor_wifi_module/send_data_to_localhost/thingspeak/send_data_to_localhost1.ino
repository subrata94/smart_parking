...
String server = "52.1.229.129"; //this ip is for api.thinhspeak.com
String uri = "/update?api_key=FEAUXFBZI6ZYK22R&field1="; //this is for api.thinhspeak.com
...
void httpGet () {
  ...
  String getRequest = "GET "+uri+cel; 
       
  Serial.println(getRequest);
  
  String sendCmd = "AT+CIPSEND=4,";    //determine the number of caracters to be sent.
  esp8266Module.print(sendCmd);
  int i = getRequest.length()+1;  //for uploading to thingspeak.com the dataline should be incremented by 1 as done here
